    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              <div className="space-y-2 text-sm text-gray-700">
                <p>
                  <strong>Decentralized:</strong> Credentials are stored on the 
                  Casper blockchain, not in a central database.
                </p>
                <p>
                  <strong>Tamper-Proof:</strong> Once issued, credentials cannot 
                  be altered without blockchain consensus.
                </p>
                <p>
                  <strong>Self-Sovereign:</strong> You control your own credentials 
                  through your wallet's private key.
                </p>
                <p>
                  <strong>Smart Contract Verified:</strong> Access is granted 
                  automatically by verifying on-chain credentials.
                </p>
              </div>
              ...
              <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                <p className="text-xs text-gray-600">
                  ...
                  <strong>Gas Required:</strong> ~10 CSPR per credential<br />
      ...
      <footer className="mt-12 py-6 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-sm text-gray-500">
          ...
          <p className="mt-1">
            Contract: <code className="text-xs bg-gray-100 px-2 py-1 rounded">
              hash-73c27...ab8fa
            </code>
          </p>
